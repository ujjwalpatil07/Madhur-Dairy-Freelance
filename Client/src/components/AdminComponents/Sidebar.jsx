...
export default function Sidebar() {
     ...
     const navItems = [
          ...
          },
          {
               ...
               to: "/admin/orders",
               orderCount: adminOrders?.length || 0,
          },
          {
               label: "Manage Customers",
               icon: <StoreIcon sx={{ fontSize: "1.2rem" }} />,
               to: "/admin/customers",
          },
     ];
      ...
      *
      * AdminLayout will NOT redirect to /admin/login because
      * its unauthorized state no longer performs navigation.
      */
