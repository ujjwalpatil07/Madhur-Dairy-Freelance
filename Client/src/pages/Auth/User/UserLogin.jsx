...
export default function UserLogin() {
     ...
     const { setAuthUser, setAuthUserLoading } =
     ...
     const handleFormSubmit = async (e) => {
          ...
          try {
               ...
               /*
                * If authentication succeeded but something failed
                * afterwards, remove the token so we don't leave the
                * application in an inconsistent authentication state.
                */
               localStorage.removeItem("accessToken");
               setAuthUser(null);
     ...
     return (
          <div className="relative flex min-h-screen w-full items-center justify-center px-4 py-8 bg-[#F0F1F3] dark:bg-[#121212] text-black dark:text-white transition-colors duration-300">
               ...
               <motion.div
                    ...
                    className={`p-6 bg-white dark:bg-gray-900 rounded-md w-lg transition duration-200 ease-in-out ${googleLoginLoading
