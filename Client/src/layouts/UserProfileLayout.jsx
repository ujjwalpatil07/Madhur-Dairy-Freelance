...
export default function UserProfileLayout({ children }) {
      ...
      *
      * During logout, authUser becomes null. If this component
      * automatically navigates to /login, it can override the
      * Navbar logout flow which should:
      *
      *      logout
      *        ↓
      *      navigate("/")
      ...
      *      open login dialog
      *
      * Therefore this layout only displays the unauthorized state.
      */
